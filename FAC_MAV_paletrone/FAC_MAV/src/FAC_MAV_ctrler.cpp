...
int main(int argc, char **argv){
	...
	reference_yaw = nh.advertise<std_msgs::Float32>("T_y_r",100);
...
//	mass_pub.publish(mass_topic);
	...
	reference_yaw.publish(T_y_r_topic);
