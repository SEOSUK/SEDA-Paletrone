...
int main(int argc, char **argv){
    ...
    static_transformStamped.transform.translation.x=-0.05395;
    static_transformStamped.transform.translation.y=0.00106;
    static_transformStamped.transform.translation.z=0.03169;
    tf2::Quaternion quat;
